...
$(document).ready(function(){
    ...
    $('.start_date_lable').find('.fa-calendar').on('click', function () {
        $('#startDateForm').trigger('focus');
    });
    $('.end_date_lable').find('.fa-calendar').on('click', function () {
    ...
    $('.start_date_edit').find('.fa-calendar').on('click', function () {
        $('#editStartDateForm').trigger('focus');
    });
    $('.end_date_edit').find('.fa-calendar').on('click', function () {
